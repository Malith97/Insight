            ...
            return this.each(function() {
                ...
                function e(a, b, d) {
                    ...
                    b && (e = parseInt(v.css("top")) + a * parseInt(c.wheelStep) / 100 * v.outerHeight(), e = Math.min(Math.max(e, 0), f), e = 0 < a ? Math.ceil(e) : Math.floor(e), v.css({
                        top: e + "px"
                    })), o = parseInt(v.css("top")) / (s.outerHeight() - v.outerHeight()), e = o * (s[0].scrollHeight - s.outerHeight()), d && (e = a, a = e / s[0].scrollHeight * s.outerHeight(), a = Math.min(Math.max(a, 0), f), v.css({
                        top: a + "px"
                    })), s.scrollTop(e), s.trigger("slimscrolling", ~~e), g(), h()
                }

                function f() {
                    n = Math.max(s.outerHeight() / s[0].scrollHeight * s.outerHeight(), q), v.css({
                        height: n + "px"
                    });
